...
class Profile {
  ...
  /// Identifies this member's Solar Hub connection point — generated by the
  /// admin when her limiter is installed, printed on the physical QR sticker
  /// at her premises. Null means the admin hasn't registered a connection
  /// for her yet, so she can't request hub usage.

  /// This member's own monthly hub allocation, set by the admin from her
  /// installed limiter's rating. Null falls back to the cooperative-wide
  /// [Cooperative.memberMonthlyQuotaKwh] default.
  final double? hubAllocationKwh;
  ...
  Profile copyWith({
    ...
    createdAt: createdAt,
    hubAllocationKwh: hubAllocationKwh ?? this.hubAllocationKwh,
  );
  ...
  factory Profile.fromRow(Map<String, dynamic> r) => Profile(
    ...
    hubAllocationKwh: rDblN(r, 'hub_allocation_kwh'),
  );
  ...
  Map<String, dynamic> toRow() => {
    ...
    'hub_allocation_kwh': hubAllocationKwh,
  };
}
