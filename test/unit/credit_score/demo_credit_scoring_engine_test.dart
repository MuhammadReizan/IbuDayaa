...
import 'package:ibudaya/features/credit_score/data/demo_credit_scoring_engine.dart';
import 'package:ibudaya/features/credit_score/domain/credit_scoring_engine.dart';

void main() {
  const engine = DemoCreditScoringEngine();
  ...
  group('DemoCreditScoringEngine — Ibu Clara canonical output', () {
  ...
  group('DemoCreditScoringEngine — band thresholds', () {
  ...
  group('DemoCreditScoringEngine — factor direction', () {
  ...
  group('DemoCreditScoringEngine — edge cases', () {
